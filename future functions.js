...
// Takes an object and turns it into a serialized string for use in a URL.
...
function serialize(obj, opt_formatter) {
...
// Takes a URL serialized string and turns it into an object.
...
function unserialize(str, opt_parser) {
  var result = {};
  str.replace(
    /([^&=]+)(?:=([^&]*))?/g,
